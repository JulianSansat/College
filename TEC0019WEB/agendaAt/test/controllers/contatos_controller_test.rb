...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { User_id: @contato.User_id, email: @contato.email, img: @contato.img, name: @contato.name, tel: @contato.tel }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { User_id: @contato.User_id, email: @contato.email, img: @contato.img, name: @contato.name, tel: @contato.tel }
    assert_redirected_to contato_path(assigns(:contato))
  end
